...
2. [ ] Define the package split so `FsFlow` contains only sync/async core concepts and `FsFlow.Net` contains all task-oriented concepts, task interop, and task-specific runtime helpers.
